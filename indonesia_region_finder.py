...
def main():
    start = time.time()
    df_provinces = pd.read_csv('data/provinces.csv', names=['id_provinces', 'name_province'], header=None)
    df_regencies = pd.read_csv('data/regencies.csv', names=['id_regencies', 'id_provinces', 'name_regency'],
                               header=None)
    df_districts = pd.read_csv('data/districts.csv', names=['id_districts', 'id_regencies', 'name_district'],
                               header=None)
    df_villages = pd.read_csv('data/villages.csv', names=['id_villages', 'id_districts', 'name_village'], header=None)
    ...
    df.to_csv("villages_in_indonesia_with_longitude_latitude.csv")
